...
class GroupServiceTest {
    ...
    @Test
    fun `save group should be successful`() =
        runBlocking {
            val insertRequest =
                GroupInsertRequest(
                    name = "Test Group",
    ...
    @Test
    fun `delete group should be successful`() =
        runBlocking {
            val group =
                Group(
                    id = 1,
    ...
    @Test
    fun `update group should be successful`() =
        runBlocking {
            val group =
                Group(
                    id = 1,
    ...
    @Test
    fun `fetch group should be successful`() =
        runBlocking {
            val group =
                Group(
                    id = 1,
    ...
    @Test
    fun `fetch not exist group should throw GroupNotExistException`(): Unit =
        runBlocking {
