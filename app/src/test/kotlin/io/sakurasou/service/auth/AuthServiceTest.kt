...
class AuthServiceTest {
    ...
    @Test
    fun `login should throw LoginFailedException for non-existent user`() =
        runBlocking {
    ...
    @Test
    fun `login should throw LoginFailedException for incorrect password`() =
        runBlocking {
            val userLoginRequest = UserLoginRequest(username, password)
    ...
    @Test
    fun `login should return a JWT token`() =
        runBlocking {
            val userLoginRequest = UserLoginRequest(username, password)
