...
class RelationDaoImpl : RelationDao {
    override fun batchInsertGroupToRoles(
        groupId: Long,
        roles: List<String>,
    ) {
    ...
    override fun batchInsertRoleToPermissions(
        roleName: String,
    ...
    override fun batchInsertPATToPermissions(
        patId: Long,
        permissionNames: List<String>,
    ) {
    ...
    override fun listPermissionByPATId(patId: Long): List<String> =
        PersonalAccessTokenPermissions
            .select(PersonalAccessTokenPermissions.permission)
