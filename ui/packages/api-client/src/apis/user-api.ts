...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [username] search username
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiUserManagePageGet: async (page: number, pageSize: number, order?: string, orderBy?: string, isBanned?: boolean, username?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiUserManagePageGet(page: number, pageSize: number, order?: string, orderBy?: string, isBanned?: boolean, username?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResponsePageResultUserPageVO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiUserManagePageGet(page, pageSize, order, orderBy, isBanned, username, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        apiUserManagePageGet(requestParameters: UserApiApiUserManagePageGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<CommonResponsePageResultUserPageVO> {
            return localVarFp.apiUserManagePageGet(requestParameters.page, requestParameters.pageSize, requestParameters.order, requestParameters.orderBy, requestParameters.isBanned, requestParameters.username, options).then((request) => request(axios, basePath));
        },
        /**
         * admin manual add user
...
export class UserApi extends BaseAPI {
    ...
    public apiUserManagePageGet(requestParameters: UserApiApiUserManagePageGetRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).apiUserManagePageGet(requestParameters.page, requestParameters.pageSize, requestParameters.order, requestParameters.orderBy, requestParameters.isBanned, requestParameters.username, options).then((request) => request(this.axios, this.basePath));
    }
